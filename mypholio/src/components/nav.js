...
const NavHeader = () => {
    return <nav className="navbar navbar-expand-lg navbar-light" style={{"height":"20px",backgroundColor: "lightgrey", borderRadius:'35px', borderLeft:"2px solid black", borderRight:"2px solid black"}}>
