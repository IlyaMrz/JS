...
/** @class */
function () {
  function Colletion(rootUrl, deserialize) {
    this.rootUrl = rootUrl;
...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new Collection_1.Colletion("http://localhost:3000/users", function (json) {
...
exports.User = User;
},{"./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/views/UserForm.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  UserForm.prototype.bindModelRerender = function () {
    var _this = this;
...
// });
// collection.fetch();
},{"./models/User":"src/models/User.ts","./views/UserForm":"src/views/UserForm.ts"}],"../../../../../Users/knpka/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
